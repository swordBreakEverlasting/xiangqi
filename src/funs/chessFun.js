...
//现在有没有被将军，后端用
//[[name,[x,y]],[name,[x,y]],[name,[x,y]],[name,[x,y]]]
function kingWillBeEaten(currentSituation,selfColor){//selfColor必须是'红'或,'黑'
...
//自己是否已经被绝杀，后端专属函数
function isBeKill(currentSituation,selfColor){//判断是否被绝杀的函数，每回合开始之前
    let mycolor = selfColor
    let enemyColor = mycolor === '红' ? '黑' : '红'
    //[[name,[x,y]],[name,[x,y]],[name,[x,y]],[name,[x,y]]]
    let allPieceAll = currentSituationArr(currentSituation)
